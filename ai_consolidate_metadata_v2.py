#!/usr/bin/env python3
"""
AI-Powered Metadata Results Consolidator V2
...
def create_countries_excel_summary(results: Dict[str, Any], output_dir: Path) -> str:
    ...
    try:
        ...
        excel_filename = output_dir / "consolidated_regulations_v2.xlsx"
        ...
        with pd.ExcelWriter(excel_filename, engine='openpyxl') as writer:
            ...
            stats_data = {
                ...
                'Value': [
                    ...
                    f"{df['Source_Documents_Total'].mean():.1f}" if 'Source_Documents_Total' in df.columns else 'N/A',
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="AI-Powered Metadata Results Consolidator V2 - Step 3 of Pipeline",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
This is STEP 3 of the regulation processing pipeline (V2):
1. regulation_pipeline.py - Scrapes regulations
2. file_metadata_processor.py - Analyzes documents  
3. ai_consolidate_metadata_v2.py - AI consolidates using ConsolidatedRegulation format with row numbers

Examples:
  python ai_consolidate_metadata_v2.py
  python ai_consolidate_metadata_v2.py --input file_metadata_analysis_results --output ai_consolidated_summaries_v2
  python ai_consolidate_metadata_v2.py --model gpt-4 --temperature 0.2
...
Output:
  ...
  - Global consolidation summary with statistics
    ...
    parser.add_argument("--output", "-o", default="ai_consolidated_summaries_v2",
    ...
    print("🚀 AI-POWERED METADATA CONSOLIDATION V2 - STEP 3")
    print("=" * 60)
    ...
    try:
        ...
        for country_folder in country_folders:
            ...
            try:
                ...
                if consolidated_summary:
                    ...
                    country_file = output_dir / f"{country}_consolidated_regulation.json"
                    ...
                    print(f"  ✅ Row {row_number} - {country}: {consolidated_summary.get('regulation_name', 'Unknown')}")
                else:
        ...
        summary_file = output_dir / "consolidation_summary_v2.json"
